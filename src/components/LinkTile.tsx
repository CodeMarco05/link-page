...
export default function LinkTile({
    ...
    return (
        ...
        >
            {/* Image Container */}
            <div className="w-full h-20 bg-gray-50 dark:bg-gray-700 flex items-center justify-center p-4">
            ...
            {/* Content */}
            <div className="p-5">
                <h3 className="text-l font-semibold font-sans text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
                    {title}
                </h3>
